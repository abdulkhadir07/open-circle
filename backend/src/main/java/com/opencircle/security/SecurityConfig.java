    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/engagements/*/ratings").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/users/me/email-change").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/users/me/email-change/verify").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/users/me/sessions").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/api/users/me/sessions").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/api/users/me/sessions/*").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/chat-rooms/*/attachments").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/chat-rooms/attachments/*/download-url").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/attachments/*/download-url").authenticated()
